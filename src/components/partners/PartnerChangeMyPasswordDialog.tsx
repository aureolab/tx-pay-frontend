...
export function PartnerChangeMyPasswordDialog({ open, onOpenChange, onSuccess }: PartnerChangeMyPasswordDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      await partnerAuthApi.changeMyPassword({
      ...
      <DialogContent className="max-w-md bg-white dark:bg-zinc-900 border-zinc-200/80 dark:border-zinc-800/80 shadow-xl shadow-amber-900/5 dark:shadow-amber-900/20 p-0 gap-0 overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="px-6 pb-6 pt-4 space-y-4">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="partner-current-password" className="text-zinc-700 dark:text-zinc-300 text-sm font-medium">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="partner-new-password" className="text-zinc-700 dark:text-zinc-300 text-sm font-medium">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="partner-confirm-password" className="text-zinc-700 dark:text-zinc-300 text-sm font-medium">
            ...
            {confirmPassword && newPassword !== confirmPassword && (
              <p className="text-xs text-red-500 mt-1">{t('dialogs.changePassword.mismatch')}</p>
            )}
          </div>
          ...
          <DialogFooter className="pt-3 border-t border-zinc-100 dark:border-zinc-800/80 -mx-6 px-6 -mb-1">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white shadow-md shadow-amber-500/20 hover:shadow-amber-500/30 transition-all duration-200 min-w-[120px] disabled:opacity-50"
            >
              {loading ? (

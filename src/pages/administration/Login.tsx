...
import { AlertCircle, ShieldCheck, ArrowRight, Sparkles, Eye, EyeOff } from 'lucide-react';
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      onBlur={() => setFocused(null)}
                      required
                      className="h-12 bg-white dark:bg-zinc-800/50 border-zinc-200 dark:border-zinc-700 rounded-xl focus:border-blue-500 focus:ring-blue-500/20 dark:focus:border-blue-400 dark:focus:ring-blue-400/20 transition-all duration-200 placeholder:text-zinc-400 pr-12"
                    />
                    <button
                      type="button"
